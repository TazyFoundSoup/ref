# ref
A terminal tool for getting quick cheat sheets of commonly used commands and tools.
...
> All cheat sheets are located in the sheet folder and can be opened with `ref <sheet name>`

- Tmux (WIP)

## License
ref is an open source program liscensed under the MIT license. Further details can be found in the (license file)[LICENSE]
