...
> All cheat sheets are located in the sheet folder and can be opened with `ss <sheet name>`

- Tmux (WIP)

## License
ss is an open source program liscensed under the MIT license. Further details can be found in the (license file)[LICENSE]
